            ...
            <div class="row">
                ...
                <div class="col-lg-10 pt-2">
                    <div class="button-action mb-3">
                        <a href="{{ route('admin.water_usage.create') }}" class="btn btn-outline-light">Thêm mới</a>
                    </div>
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th class="bg-dark text-white" scope="col">Khối lượng nước sử dụng (m3)</th>
                                <th class="bg-dark text-white" scope="col">Thời gian sử dụng</th>
