            ...
            <div class="row">
                ...
                <div class="col-lg-10 pt-2">
                    <div class="button-action mb-3">
                        <a href="{{ route('admin.wells.create') }}" class="btn btn-outline-light">Thêm mới</a>
                    </div>
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th class="bg-dark text-white" scope="col">Độ sâu</th>
                                <th class="bg-dark text-white" scope="col">Mức nước</th>
                                <th class="bg-dark text-white" scope="col">Trạng thái</th>
