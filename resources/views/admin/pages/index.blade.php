    ...
    <div class="list-content-action">
      <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-6">
          <div class="card bg-dark text-white text-center p-lg-4 p-md-3">
            ...
            <div class="card-body pt-0">
              ...
              <a href="{{ route('admin.wells.index') }}" class="btn btn-primary card-link">Xem số liệu chất lượng
                nước</a>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6">
          <div class="card bg-dark text-white text-center p-lg-4 p-md-3">
            ...
            <div class="card-body pt-0">
              ...
              <a href="{{ route('admin.reports.index') }}" class="btn btn-primary card-link">Xem báo cáo</a>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6">
          <div class="card bg-dark text-white text-center p-lg-4 p-md-3">
            ...
            <div class="card-body pt-0">
              ...
              <a href="{{ route('admin.users.index') }}" class="btn btn-primary card-link">Xem thông tin</a>
            </div>
          </div>
        </div>
      </div>
